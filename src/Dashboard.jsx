  ...
  return (
    <div className="bg-[#F2F6FF] flex w-3/4 h-full">
      ...
      <div className="flex flex-col w-3/4 h-full">
        <MainBar />
        <div className="CenterBar flex bg-[#F2F6FF] absolute top-28 right-0 overflow-hidden">
          <div className="CenterLeftBar flex flex-col items-center m-6 overflow-x-auto">
            <div className="flex">
